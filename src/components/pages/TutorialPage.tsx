...
const TUTORIAL_TOPICS: TutorialTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: '4. 骨碌碌收集安科', description: '在统一收集页面顶部点击「📕 骨碌碌安科」Tab 切换到骨碌碌面板。粘贴骨碌碌作品链接（格式 <code>https://www.gululu.world/book/1285</code>），填写楼层范围与分节粒度，点击「🔍 自动检测」可获取作品总楼数。骨碌碌楼层无独立作者，标题用"—— 第 X 节 ——"格式。' },
